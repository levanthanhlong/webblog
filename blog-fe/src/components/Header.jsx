...
const Header = () => {
   ...
   const displayName = userState?.userInfo?.name
   const displayAvatar = userState?.userInfo?.avatar
      ? userState?.userInfo?.avatar.includes('http://') || userState?.userInfo?.avatar.includes('https://')
               ...
               {userState.userInfo ? (
                  <div className="text-white items-center gap-y-5 lg:text-dark-soft flex flex-col lg:flex-row gap-x-2 font-semibold">
                     <div className="relative group">
                        <div className="flex flex-col items-center">
                           <button
                              className="flex gap-x-1 items-center mt-5 lg:mt-0 border-2 border-blue-500 px-4 py-2 rounded-full text-blue-500 font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300"
                           ...
                           <div
                              ...
                              } lg:hidden transition-all duration-500 pt-4 lg:absolute lg:bottom-0 lg:right-0 lg:white lg:translate-y-full lg:group-hover:block w-max`}
                           >
